...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/jira_training_cloner?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/jira_training_cloner/badge)](http://codestats-url/organizations/your-organization/projects/jira_training_cloner/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/jira_training_cloner.git`
- Go to the project root by running `cd jira_training_cloner`
...
```bash
  ...
  CREATE ROLE "jira_training_cloner" LOGIN CREATEDB PASSWORD 'jira_training_cloner';
```
